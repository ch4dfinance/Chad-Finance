...
contract L2Conjurer is Ownable {
    ...
    // Vault address on mainnet for Base
    address public constant baseVault = 0x26C6E529487a19E4098C8803612DE4877e1C2fc9;
    ...
    function burnToMainnet(uint256 amount) external onlyOwner {
        ...
        bridge.bridgeERC20To(address(stablecoin), l1Stablecoin, baseVault, amount, 150_000, new bytes(0));
